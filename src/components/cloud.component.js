...
export default class Tutorial extends Component {
    ...
    updatePublished(status) {
        CloudDataService.update(this.state.currentTutorial.id, {
            published: status,
        })
        .then(() => {
            this.setState((prevState) => ({
    ...
    updateTutorial() {
        ...
        CloudDataService.update(this.state.currentTutorial.id, data)
        .then(() => {
            this.setState({
    ...
    deleteTutorial() {
      CloudDataService.delete(this.state.currentTutorial.id)
        .then(() => {
